...
public class JSONAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if(getItemViewType(position) == ViewTypes.FAQ_TYPE.ordinal()) res = R.layout.dtable_popdown_row;
            else if(getItemViewType(position) == ViewTypes.CAT_TYPE.ordinal()) res = R.layout.category_row;
