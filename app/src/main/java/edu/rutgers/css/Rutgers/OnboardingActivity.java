...
public class OnboardingActivity extends AppCompatActivity {
    ...
    ArrayList<TutorialPageFragment> tutorialFragments;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_onboarding);
        this.pager = (ViewPager)findViewById(R.id.onboarding_view_pager);
        this.tutorialFragments = new ArrayList<TutorialPageFragment>();
    ...
    public void addCustomFragment(TutorialPageFragment fragment) {
    ...
    public void addPreloadedFragment(int imgsrc, String title, String description) {
        ...
        tutorialFragment.setImageDisplayed(imgsrc);
