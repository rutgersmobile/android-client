 ...
 */
public class NextBusItemLoader extends AsyncTaskLoader<List<SimpleSection<NextbusItem>>> {

    private List<SimpleSection<NextbusItem>> data;
    ...
    @Override
    public void deliverResult(List<SimpleSection<NextbusItem>> keyValPairs) {
        if (isReset()) {
            return;
        }

        List<SimpleSection<NextbusItem>> oldItems = data;
        data = keyValPairs;
        if (isStarted()) {
